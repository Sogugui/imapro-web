    ...
    return (<section className="bg-gray-900 min-h-screen w-full text-gray-200">
        <div className="container px-6 py-10 mx-auto">
            ...
            <p className="mt-4 text-gray-100 text-2xl xl:mt-6 dark:text-gray-300">
                ...
                IMAPRO tiene como objetivo brindarle soluciones a las distintas necesidades de cada cliente, proporcionando un servicio con eficiencia y calidad.
                Contamos con personal idóneo con experiencia, así como profesionales capacitados en el rubro.
                Utilizamos productos, recursos y materiales de primera calidad, con el fin de que sólo tenga el placer de disfrutar y administrar su tiempo.
                Para ello, tener en cuenta que nuestros presupuestos son altamente competitivos en el mercado actual.
            </p>
