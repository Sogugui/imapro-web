...
IMAPRO Argentina tiene como objetivo brindarle soluciones a los distintas necesidades de cada cliente, proporcionando un servicio con eficiencia y calidad, contamos con personal idóneo con experiencia, así como profesionales capacitados en el rubro.

Utilizando productos, recursos y materiales de primera calidad, con el fin de que sólo tenga el placer de disfrutar y administrar su tiempo. Para ello, tener en cuenta que nuestros presupuestos son altamente competitivos en el mercado actual.
        </p>
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
            ...
            <div className="p-8 space-y-3 border-2 border-lime-700  rounded-xl hover:scale-110 transition-transform">
                ...
                <ol className=" text-xl text-gray-500 dark:text-gray-300 flex flex-col items-start text-left">
