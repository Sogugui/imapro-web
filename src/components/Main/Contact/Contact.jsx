            ...
            <div id='direcciones' className="text-white lg:w-1/2 lg:mx-6">
                ...
                <div className="mt-6 md:mt-8">
                    ...
                    <div className="flex mt-4 -mx-1.5 justify-center ">
                        ...
                        <a className="mx-1.5 text-white transition-colors duration-300 transform hover:text-blue-500" href="https://www.instagram.com/imaproargentina/?hl=es" target="_blank">
                            <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
