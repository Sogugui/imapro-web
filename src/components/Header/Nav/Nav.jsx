      ...
      <div className='lg:hidden  select-none bg-slate-100 font-poppins'>
        ...
        >
          <div className='flex gap-4 w-1/3'>
            <Link onClick={toggleBar} to="/" className='text-2xl'>Inicio</Link>
          </div>
          <div className='flex gap-4 w-1/3'>
            <Link onClick={toggleBar} to ="/about" className='text-2xl'>Quiénes somos</Link>
          </div>
          <div className='flex gap-4 w-1/3'>
            <Link onClick={toggleBar} to ="/ourwork" className='text-2xl'>Qué hacemos</Link>
          </div>
          <div className='flex gap-4 w-1/3'>
            <Link onClick={toggleBar} to ="/clients" className='text-2xl'>Clientes</Link>
          </div>
          <div className='flex gap-4 w-1/3'>
            <Link onClick={toggleBar} to ="/assets" className='text-2xl'>Galería</Link>
          </div>
          <div className='flex gap-4 w-1/3'>
            <Link onClick={toggleBar} to ="/contact" className='text-2xl'>Contacto</Link>
          </div>
        </div>
      </div>
      ...
      <div className='font-poppins hidden lg:flex justify-between px-24 py-4 bg-neutral-100/90 shadow-md items-center select-none'>
        <div className='flex items-center gap-2 text-xl group'>
          <Link  to="/" className='text-2xl'>
            <span className='text-lime-700 font-semibold'>I</span>mapro <span className='text-action font-semibold'>Argentina</span>
          </Link>
        </div>
        <div className='flex gap-14 text-xl items-center'>
          ...
          <Link  to="/clients" className='flex items-center gap-2 group'>
            <span>Clientes</span>
          </Link>
          <Link  to="/assets" className='flex items-center gap-2 group'>
            <span>Galería</span>
          </Link>
